...
- (IBAction)signInButton:(id)sender {
    ...
    NSString *urlBaseString = @"http://ec2-54-85-248-35.compute-1.amazonaws.com:8000/bsignin?";
    NSString *emailText =email.text;
    NSString *pswText = psw.text;
    IPAdd = [self getIPAddress:true];
    NSLog(@"IP:%@",IPAdd);
    NSString *urlFinal = [NSString stringWithFormat: @"%@Email=%@&Psw=%@&Location=%@+%@&IP=%@",urlBaseString,emailText,pswText,lat,lng,IPAdd];
